...
$MESS ['MYMS_PARAM_OPTIONS_ENABLE_CONT_ZOOM'] = "постепенное изменение масштаба";
$MESS ['MYMS_PARAM_OPTIONS_ENABLE_GOOGLE_BAR'] = "инструмент \"панель Google\"";
$MESS ['MYMS_PARAM_CONTROLS'] = "Элементы управления";
$MESS ['MYMS_PARAM_CONTROLS_LARGE_MAP_CONTROL'] = "Управление картой";
$MESS ['MYMS_PARAM_CONTROLS_SMALL_MAP_CONTROL'] = "Компактное управление картой";
...
$MESS ['MYMS_PARAM_CONTROLS_HTYPECONTROL'] = "Тип карты (иерархический)";
