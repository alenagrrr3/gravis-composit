...
if (window.YMaps)
{
	(function BXWaitForMap1(){if(window.bYandexMapScriptsLoaded){jsYandexCE.init();}else{setTimeout(BXWaitForMap1,500)}})();
}
else
{
(function BXWaitForMap(){if(null==window.GLOBAL_arMapObjects)return;if(window.GLOBAL_arMapObjects['system_view_edit']){jsYandexCE.init();}else{setTimeout(BXWaitForMap,300);}})();
}
</script>
<?
