var jsYandexCE_search = {
	...
	init: function() 
	{
		...
		YMaps.Events.observe(jsYandexCE_search.map, jsYandexCE_search.map.Events.Move, jsYandexCE_search.__getPositionValues);
		YMaps.Events.observe(jsYandexCE_search.map, jsYandexCE_search.map.Events.Update, jsYandexCE_search.__getPositionValues);
		YMaps.Events.observe(jsYandexCE_search.map, jsYandexCE_search.map.Events.ChangeType, jsYandexCE_search.__getPositionValues);
	...
	restorePositionValues: function(e)
	{
		...
		if (jsYandexCE_search.currentView && YMaps.MapType[jsYandexCE_search.currentView])
			jsYandexCE_search.map.setType(YMaps.MapType[jsYandexCE_search.currentView]);
		
		jsYandexCE_search.map.setZoom(jsYandexCE_search.arData.yandex_scale);
		jsYandexCE_search.map.panTo(new YMaps.GeoPoint(jsYandexCE_search.arData.yandex_lon, jsYandexCE_search.arData.yandex_lat));
	},
