	...
	else
	{
		...
		if($arResult["preview"] == "Y" && !empty($arResult["PostToShow"])>0)
		{
			...
			<div class="blog-post-info">
				...
				<div class="blog-post-date"><?=$arResult["postPreview"]["DATE_PUBLISH_FORMATED"]?></div>
			</div>
			<div class="blog-post-content">
				...
				<div class="blog-post-meta">
					<div class="blog-post-meta-util">
						<span class="blog-post-comments-link"><?=GetMessage("BLOG_COMMENTS")?>: 0</span>
						<span class="blog-post-meta-sep">|</span>
						<span class="blog-post-views-link"><?=GetMessage("BLOG_VIEWS")?>: 0</span>
					</div>
		...
		<?=bitrix_sessid_post();?>
		<div class="blog-post-edit-form">
		<div class="blog-post-fields">
			<div class="blog-post-field blog-post-field-title">
				<div class="blog-post-field-text">
				<label for="POST_TITLE"><?=GetMessage("BLOG_TITLE")?></label><span class="blog-required-field">*</span>
				</div>
			...
			<div class="blog-post-field blog-post-field-category">
				<div class="blog-post-field-text">
				<label for="TAGS"><?=GetMessage("BLOG_CATEGORY")?></label>
				</div>
				<span><?
						if(IsModuleInstalled("search"))
						{
							$APPLICATION->IncludeComponent("bitrix:search.tags.input", ".default", Array(
								...
								"PAGE_ELEMENTS"	=>	"10",
								"SORT_BY_CNT"	=>	"Y",
								"TEXT" => 'size="30" tabindex="2"'
								)
							);
						}
						else
						{
							?><input type="text" id="TAGS" tabindex="2" name="TAGS" size="30" value="<?=$arResult["PostToShow"]["CategoryText"]?>">
							<?
						}?>
				</span>
			</div>
			<div class="blog-clear-float"></div>
			<div class="blog-post-field blog-post-field-date">
		...
		<div class="blog-post-message">
			<div class="blog-comment-field blog-comment-field-bbcode">
				...
				<div id="edit-post-text" style="display:none;">
					...
					<div class="blog-comment-field blog-comment-field-text">
						<textarea cols="55" rows="15" tabindex="3" onKeyPress="check_ctrl_enter(arguments[0])" name="POST_MESSAGE" id="MESSAGE" onKeyPress="check_ctrl_enter(arguments[0])"><?=$arResult["PostToShow"]["DETAIL_TEXT"]?></textarea>
					</div>
				</div>
			</div>
			...
			?>
			<div class="blog-post-field blog-post-field-images" id="blog-post-image">
			<?
		...
		{
			?>
			<div class="blog-post-field blog-post-field-favorite">
		...
		<div class="blog-post-params">
			<?if($arResult["bSoNet"] != "Y")
			{
				...
				?>
				<div class="blog-post-field blog-post-field-access">
					<div><?=GetMessage("BLOG_ACCESS")?></div>
			...
			<?if($arResult["POST_PROPERTIES"]["SHOW"] == "Y"):?>
				<div class="blog-post-field blog-post-field-user-prop">
