...
/***************** BASE ********************************************/
	...
	$arParams["TYPE"] = strToUpper(in_array(strToUpper($arParams["TYPE"]), $arParams["TYPE_RANGE"]) ? $arParams["TYPE"] : false);
...
if($this->StartResultCache(false, array($cache_id_array, $arParams["DESIGN_MODE"]), "/".SITE_ID."/forum/rss/".$arParams["TYPE"]."/".$arParams["MODE_DATA"]."/"))
{
	$arFilter = array(
