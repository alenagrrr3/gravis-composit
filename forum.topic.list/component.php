...
/********************************************************************
				Default values
********************************************************************/
$arResult["PERMISSION"] = ForumCurrUserPermissions($arParams["FID"]);
...
while ($res = $db_res->GetNext())
{
	...
	elseif (NewMessageTopic($res["FORUM_ID"], $res["ID"], $res["LAST_POST_DATE"], $res["LAST_VISIT"]))
	{
		$res["TopicStatus"] = "NEW";
	}
/*******************************************************************/
