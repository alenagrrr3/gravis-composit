...
if(isset($arResult["ID"]))
{
	if($USER->IsAuthorized())
	{
		if($GLOBALS["APPLICATION"]->GetShowIncludeAreas() && CModule::IncludeModule("iblock"))
			$this->AddIncludeAreaIcons(CIBlock::ShowPanel($arResult["ID"], 0, $arParams["PARENT_SECTION"], $arResult["IBLOCK_TYPE_ID"], true));
		if($arParams["DISPLAY_PANEL"] && CModule::IncludeModule("iblock"))
			CIBlock::ShowPanel($arResult["ID"], 0, $arParams["PARENT_SECTION"], $arResult["IBLOCK_TYPE_ID"], false, $this->GetName());
	}
